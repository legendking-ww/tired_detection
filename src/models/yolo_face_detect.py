...
class YOLO_face:
    ...
    def draw_detections(self, image, boxes, scores, kpts):
        for box, score, kp in zip(boxes, scores, kpts):
            ...
            cv2.putText(image, "face:" + str(round(score, 2)), (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0),
                        thickness=1)
            for i in range(5):
...
# parser.add_argument('--imgpath', type=str, default='./images/test/unknown_1.jpg', help="image path")
